...
public final class ItemAppBinding implements ViewBinding {
  ...
  private ItemAppBinding(@NonNull MaterialCardView rootView, @NonNull ImageView ivAppIcon,
      @NonNull SwitchMaterial switchApp, @NonNull TextView tvAppName,
  ...
  public static ItemAppBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemAppBinding((MaterialCardView) rootView, ivAppIcon, switchApp, tvAppName,
          tvPackageName);
    }
