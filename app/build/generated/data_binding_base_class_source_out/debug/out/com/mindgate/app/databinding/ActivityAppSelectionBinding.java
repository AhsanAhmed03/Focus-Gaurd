...
public final class ActivityAppSelectionBinding implements ViewBinding {
  ...
  private ActivityAppSelectionBinding(@NonNull CoordinatorLayout rootView,
      @NonNull MaterialButton btnClearAll, @NonNull MaterialButton btnSave,
      @NonNull MaterialButton btnSelectAll, @NonNull TextInputEditText etSearch,
      @NonNull ProgressBar progressLoading, @NonNull RecyclerView recyclerApps,
      @NonNull MaterialToolbar toolbar, @NonNull TextView tvSelectionCount) {
  ...
  public static ActivityAppSelectionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAppSelectionBinding((CoordinatorLayout) rootView, btnClearAll, btnSave,
          btnSelectAll, etSearch, progressLoading, recyclerApps, toolbar, tvSelectionCount);
    }
